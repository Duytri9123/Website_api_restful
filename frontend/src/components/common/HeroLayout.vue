<template>
  <div class="bg-white"> 
    <div class="mx-auto w-full sm:w-full py-0 sm:px-6 sm:py-0 lg:px-24 ">
      <div
        class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-2xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0"
      >
        <svg
        ...
        <div
          class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-50 lg:text-left"
        >
          <h2
        ...
        <div class="relative mt-16 h-40 lg:mt-8">
          <img
