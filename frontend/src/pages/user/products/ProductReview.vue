          ...
          <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div class="grid md:grid-cols-12 gap-4 md:gap-6 py-4 md:py-6">
              ...
              <dl class="md:col-span-6 order-4 md:order-2">
                <dt class="sr-only">Message:</dt>
                <dd class="text-gray-500 dark:text-gray-400">
                  Elegant look, exceptional keyboard, and well-matched accessories.
                  Lightning-quick speed, impressive battery duration...
                </dd>
              </dl>
            ...
            <div class="grid md:grid-cols-12 gap-4 md:gap-6 py-4 md:py-6">
              ...
              <dl class="md:col-span-6 order-4 md:order-2">
                <dt class="sr-only">Message:</dt>
                <dd class="text-gray-500 dark:text-gray-400">
                  The DualSense controller enhances gameplay with immersive feedback,
                  making it a must-have for gaming...
                </dd>
              </dl>
            ...
            <div class="grid md:grid-cols-12 gap-4 md:gap-6 py-4 md:py-6">
              ...
              <dl class="md:col-span-6 order-4 md:order-2">
                <dt class="sr-only">Message:</dt>
                <dd class="text-gray-500 dark:text-gray-400">
                  Elegant and refined, with well-chosen accessories. Quick response,
                  durable battery, and everything runs smoothly...
                </dd>
              </dl>
            ...
            <div class="grid md:grid-cols-12 gap-4 md:gap-6 py-4 md:py-6">
              ...
              <dl class="md:col-span-6 order-4 md:order-2">
                <dt class="sr-only">Message:</dt>
                <dd class="text-gray-500 dark:text-gray-400">
                  The console's design might not appeal to everyone, and exclusive titles
            ...
            <div class="grid md:grid-cols-12 gap-4 md:gap-6 py-4 md:py-6">
              ...
              <dl class="md:col-span-6 order-4 md:order-2">
                <dt class="sr-only">Message:</dt>
                <dd class="text-gray-500 dark:text-gray-400">
                  The camera system continues to excel, capturing high-quality photos and
                  videos...
                </dd>
              </dl>
            ...
            <div class="grid md:grid-cols-12 gap-4 md:gap-6 py-4 md:py-6">
              <dl class="md:col-span-3 order-3 md:order-1">
                ...
                <dd class="text-base font-semibold text-gray-900 dark:text-white">
                  <a href="#" class="hover:underline"
                    >Sony a7 III (ILCEM3K/B) Full-frame Mirrorless</a
                  >
                </dd>
              </dl>
              ...
              <dl class="md:col-span-6 order-4 md:order-2">
                <dt class="sr-only">Message:</dt>
                <dd class="text-gray-500 dark:text-gray-400">
                  The Sony a7 III is a versatile mirrorless camera that excels in both
            ...
            <div class="grid md:grid-cols-12 gap-4 md:gap-6 pt-4 md:pt-6">
              <dl class="md:col-span-3 order-3 md:order-1">
                ...
                <dd class="text-base font-semibold text-gray-900 dark:text-white">
                  <a href="#" class="hover:underline"
                    >Brother MFC-J1010DW Wireless Color Inkjet</a
                  >
                </dd>
              </dl>
              ...
              <dl class="md:col-span-6 order-4 md:order-2">
                <dt class="sr-only">Message:</dt>
                <dd class="text-gray-500 dark:text-gray-400">
                  The inkjet printer has been a frustrating experience. Print quality is
                  inconsistent, with colors often...
                </dd>
              </dl>
